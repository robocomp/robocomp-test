...
/** \mainpage RoboComp::doblebuffer
 *
 * \section intro_sec Introduction
 *
 * The doblebuffer component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/doblebuffer --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class doblebuffer : public RoboComp::Application
{
public:
	doblebuffer (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::doblebuffer::run(int argc, char* argv[])
{
