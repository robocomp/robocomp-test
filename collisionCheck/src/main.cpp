...
/** \mainpage RoboComp::collisionCheck
 *
 * \section intro_sec Introduction
 *
 * The collisionCheck component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/collisionCheck --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class collisionCheck : public RoboComp::Application
{
public:
	collisionCheck (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::collisionCheck::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
