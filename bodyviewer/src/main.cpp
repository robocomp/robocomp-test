...
/** \mainpage RoboComp::bodyviewer
 *
 * \section intro_sec Introduction
 *
 * The bodyviewer component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/bodyviewer --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class bodyviewer : public RoboComp::Application
{
public:
	bodyviewer (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::bodyviewer::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
