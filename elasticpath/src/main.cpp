...
/** \mainpage RoboComp::elasticpath
 *
 * \section intro_sec Introduction
 *
 * The elasticpath component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/elasticpath --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class elasticpath : public RoboComp::Application
{
public:
	elasticpath (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::elasticpath::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
