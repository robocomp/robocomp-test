...
/** \mainpage RoboComp::rgbd2april
 *
 * \section intro_sec Introduction
 *
 * The rgbd2april component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/rgbd2april --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class rgbd2april : public RoboComp::Application
{
public:
	rgbd2april (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::rgbd2april::run(int argc, char* argv[])
{
