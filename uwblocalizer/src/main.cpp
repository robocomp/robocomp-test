...
/** \mainpage RoboComp::uwblocalizer
 *
 * \section intro_sec Introduction
 *
 * The uwblocalizer component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/uwblocalizer --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class uwblocalizer : public RoboComp::Application
{
public:
	uwblocalizer (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
