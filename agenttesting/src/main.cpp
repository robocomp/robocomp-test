...
/** \mainpage RoboComp::agenttesting
 *
 * \section intro_sec Introduction
 *
 * The agenttesting component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/agenttesting --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class agenttesting : public RoboComp::Application
{
public:
	agenttesting (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::agenttesting::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
