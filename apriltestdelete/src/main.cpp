...
/** \mainpage RoboComp::apriltestdelete
 *
 * \section intro_sec Introduction
 *
 * The apriltestdelete component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/apriltestdelete --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class apriltestdelete : public RoboComp::Application
{
public:
	apriltestdelete (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::apriltestdelete::initialize()
{
...
int ::apriltestdelete::run(int argc, char* argv[])
{
	...
	try
	{
		...
		camerasimple_proxy = Ice::uncheckedCast<CameraSimplePrx>( communicator()->stringToProxy( proxy ) );
	}
	catch(const Ice::Exception& ex)
	{
